...
typedef struct _leshiBTmeshGWMsg {
    ...
    char deviceVer[64]; /* device version */
    char hb_time[64]; /* heartbeat time */
} leshiBTmeshGWMsg;
...
#define leshiBTmeshGWMsg_init_default            {"", "", 0, "", 0, 0, {Datapoint_init_default, Datapoint_init_default, Datapoint_init_default, Datapoint_init_default, Datapoint_init_default, Datapoint_init_default, Datapoint_init_default, Datapoint_init_default, Datapoint_init_default, Datapoint_init_default}, 0, 0, {0}, "", ""}
...
#define commonMessage_init_default               {_messageType_MIN, false, direction_init_default, 0, false, Gatewayinfo_init_default, 0, false, GatewayOta_init_default, 0, {combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default, combineMsg_init_default}}
...
#define leshiBTmeshGWMsg_init_zero               {"", "", 0, "", 0, 0, {Datapoint_init_zero, Datapoint_init_zero, Datapoint_init_zero, Datapoint_init_zero, Datapoint_init_zero, Datapoint_init_zero, Datapoint_init_zero, Datapoint_init_zero, Datapoint_init_zero, Datapoint_init_zero}, 0, 0, {0}, "", ""}
...
#define commonMessage_init_zero                  {_messageType_MIN, false, direction_init_zero, 0, false, Gatewayinfo_init_zero, 0, false, GatewayOta_init_zero, 0, {combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero, combineMsg_init_zero}}
...
X(a, STATIC,   FIXARRAY, MESSAGE,  combo,            11)
