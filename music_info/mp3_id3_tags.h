 ...
 * @Company      : HOPE
 * @Author       : MCD
 * @Date         : 2023-02-27 09:34:32
 * @LastEditors  : MCD
 * @LastEditTime : 2023-02-27 09:39:32
 * @FilePath     : /My_C_Test/music_info/mp3_id3_tags.h
 * @Description  : 
 * 
 * ******************************************
 */
...
int mp3_id3__read_id3(FILE *f, char *id3) {
    ...
    if (fread(id3, sizeof(char), 128, f) < 128) {
        mp3_id3__err("Read less than 128 bytes from the file");
        return 0;
    }
