 ...
 * @LastEditors  : MCD
 * @LastEditTime : 2022-09-16 14:58:32
...
// static int _eide_rs485_simple_control(llq_t *llq_handle, rs485_data_t *data,
// int datalen)
// {
 ...
 * @details		装载填充 数据头
 */
static int _eide_rs485_head_fill(char               version,
 ...
 */
static int eide_rs485_configration(char                  operation_code,
                                   unsigned short        config_func_code,
                                   eide_rs485_payload_t *payload)
{
    ...
    switch (operation_code) {
        case EIDE_CONFIG_READ: break;
        case EIDE_CONFIG_WRITE: break;
        case EIDE_CONFIG_ADD: break;
        case EIDE_CONFIG_DELETE: break;
        default: break;
    }
    len++;
    return len;
...
int eide_rs485_get_module_info(void)
{
    ...
    _eide_rs485_head_fill(EIDE_RS485_VERSION, eide_serial, EIDE_RS485_FLAGS,
                          0x00, src_mac_addr, broadcast_mac_addr,
                          EIDE_RS485_ENCRYPTION_TYPE, &rs485_msg.header);

    payload_len = eide_rs485_configration(EIDE_CONFIG_READ,
                                          EIDE_CONFIG_CODE_MODULE_DEVICE_INFO,
                                          &rs485_msg.payload);
...
// 27 + 2
// 1D 00 01 00 00 00 12 23 34 45 56 67 78 89 FF FF FF FF FF FF FF FF 00 01 00 00
// 02 4A BC